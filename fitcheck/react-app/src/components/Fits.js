        ...
        return (
            ...
            <div style={{ textAlign: 'left' }}>
                ...
                {Object.keys(this.state.outfitList).map((o_l) => {
                    ...
                    return (
                        <div key={o_l.toString()} style={{ height: '700px', width: '290px', backgroundColor: '#eee', marginTop: '120px', marginLeft: '50px', borderRadius: '12px', position: 'relative', boxShadow: "0 3px 6px 2px rgba(0, 0, 0, 0.07)", display: 'inline-block' }}>
                ...
                <div className="block_wrap newOutfitButton" style={{ height: '700px', width: '290px', marginTop: '120px', marginLeft: '50px', borderRadius: '12px', position: 'relative', border: '2px solid #ebebeb', borderStyle: 'dashed', boxSizing: 'border-box', display: 'inline-table', cursor: 'pointer' }}>
